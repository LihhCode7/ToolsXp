<head>
<title>Auto Visitor | ./Hidan X-ploit</title>
<meta name="description" content="Auto Visitor || ./Hidan X-ploit" />
...
<center><div class="panel panel-primary panelMove toggle panelRefresh panelClose">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><font color="white" face="Kelly Slab" size="70px" style="text-shadow: 0px 0px 10px;">Auto Visitor
                                        <hr />
                                    </div>
...
<input type="text" name="url" value="https://your.site.blog.com">
