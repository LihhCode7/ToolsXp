...
<head>
    ...
    <title>Jso Generator || ./Lihh X-ploit</title>
    <meta name="description" content="[ Jso Generator ]">
...
<form name="charCodeAt" method="post">
		<textarea name="input" class="textarea" placeholder="tempelkan code html script depes lu"></textarea><br><br>
